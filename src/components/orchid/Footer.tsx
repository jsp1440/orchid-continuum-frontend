  ...
  return (
    <footer className="relative bg-ink text-[#f5f0e8] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 py-14 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-10">
          ...
          {cols.map(c => (
            <div key={c.title} className="md:col-span-2">
              <div className="font-mono text-[10px] tracking-[0.25em] uppercase text-gold-soft mb-4">
                {c.title}
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-[#d4b34a]/20">
          <div className="grid md:grid-cols-12 gap-8">
            <div className="md:col-span-7">
              ...
              <p className="font-body text-[15px] text-[#e7dfd1]/90 mt-3 leading-relaxed max-w-2xl">
                Orchid Continuum is an independent biodiversity intelligence initiative — a community-oriented, federated infrastructure for orchid science and conservation, fiscally sponsored by{' '}
                <a
        ...
        <div className="mt-10 pt-5 border-t border-[#d4b34a]/15 flex flex-col md:flex-row md:items-center md:justify-between gap-4">

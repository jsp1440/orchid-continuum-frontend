 ...
 * This wrapper adds canonical continuations into Research Station and the
 * Species browser using the same bounded featured-taxon navigation boundary.
 * Only genus identity crosses these boundaries; coordinates, locality,
 * occurrence ids, collectors, catalogue numbers, and other Atlas-level record
 * detail have no channel. Research additionally receives the explicit
 * non-evidence declaration required by its trust boundary.
 */
        ...
        <div className="mx-auto max-w-6xl rounded-xl border border-[#d1bd8e] bg-[#fffaf0] px-5 py-4 sm:flex sm:items-center sm:justify-between sm:gap-6">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-[#526046]">
              Carry {genus} into Research Station or browse its Species dossiers as bounded navigation context.
            </p>
          </div>

...
export interface OrganizationCardProps {
  ...
  focus?: string[];
  /** Mark as a synthetic interface placeholder until canonical backend integration. */
  demo?: boolean;
}
...
const OrganizationCard: React.FC<OrganizationCardProps> = ({
  ...
  const card = (
    <div className="p-6 flex flex-col h-full">
      ...
      {demo ? (
        <p className="text-[13px] text-amber-100/75 leading-relaxed mb-4 font-light">
          Synthetic interface example only. Organization identity, location, activity, counts, and ecological claims are not Continuum evidence and are intentionally suppressed until a canonical organization contract supplies them.
        </p>
      ) : (
        <>

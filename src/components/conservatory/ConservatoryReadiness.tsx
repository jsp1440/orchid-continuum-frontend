...
export function useConservatoryReadiness() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      if (!Array.isArray(next.gates) || typeof next.ready_for_collection_entry !== "boolean") {

...
const JOINS: JoinSpec[] = [
  ...
  },
  {
    ...
    nextAction: 'Owner-gated deployed-backend verification remains; automation must not infer production readiness from the provider-free contract fixture.',
    lastAccomplishment: '#657 proved the real mounted dossier producer and Matrix consumer preserve the exact canonical taxon id without promoting it to evidence.',
  },
  {
    id: 'research-atlas',
  ...
  },
  {
    ...
    tests: ['src/lib/classroomInvestigationNavigation.test.ts', 'e2e/classroom-calyx-learner-register.spec.ts'],
    prs: ['#343'],
    browser: 1,

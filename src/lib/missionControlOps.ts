...
export async function fetchMissionControlOperations(): Promise<MissionControlOperations> {
  const [
    ...
    getJson<Record<string, unknown>>(CALYX_BACKEND_BASE_URL, '/api/runner/constitutional/status', 'Constitutional status'),
    getJson<Record<string, unknown>>(CALYX_BACKEND_BASE_URL, '/api/runner/constitutional/missions', 'Constitutional missions'),
    getJson<Record<string, unknown>>(CALYX_BACKEND_BASE_URL, '/api/runner/constitutional/policies', 'Constitutional policies'),
    getJson<Record<string, unknown>>(CALYX_BACKEND_BASE_URL, '/api/runner/constitutional/decision-ledger', 'Decision ledger'),

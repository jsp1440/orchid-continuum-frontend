...
function governedMission(): BrainMission {
  return {
    ...
    reasoning_ledger: { ledger_id: "oc-demo-ledger-1", version: 1 },
...
describe("Partner-neutral Orchid Continuum governed verification continuity", () => {
  it("keeps Research identity non-evidentiary while Check Calyx audits only governed evidence", () => {
    ...
    expect(verification.provenance).toMatchObject({
      missionId: "oc-demo-phalaenopsis-mission",
      reasoningLedgerId: "oc-demo-ledger-1",

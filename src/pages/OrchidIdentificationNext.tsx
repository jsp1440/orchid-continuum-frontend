    ...
    <main className="min-h-screen bg-background px-4 py-10 text-foreground sm:px-6">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-4 max-w-4xl text-muted-foreground">
          Supply observable characters and a governed candidate matrix. Calyx ranks candidates, reports data coverage, and explains every match, partial match, conflict, unknown, and missing candidate state. A ranking is a derived analytical result for review—not a verified identification.
        </p>

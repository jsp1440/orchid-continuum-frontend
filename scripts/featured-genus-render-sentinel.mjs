...
const report = { frontendUrl, calyxUrl, genera: {}, browser: {} };
...
try {
  ...
  await assert.equal(await feature.count(), 1, 'Featured Genus section was not rendered');
  ...
  report.browser = { imageState, noMediaText, errors };

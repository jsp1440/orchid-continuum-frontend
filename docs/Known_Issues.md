...
| Architecture repository access may return 404 | Open | Keep this as a controlled WARN until repository visibility and connector access are resolved in a later build. |
